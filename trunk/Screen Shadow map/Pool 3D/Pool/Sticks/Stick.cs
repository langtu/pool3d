    ...
    public class Stick : BasicModel
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (!World.poolTable.ballsMoving)
            {
                ...
                //direction = new Vector3((float)-Math.Cos(MathHelper.ToRadians(angleY)), 0, (float)Math.Sin(MathHelper.ToRadians(angleY)));
                Direction.Normalize();
            ...
            v.Normalize();
            Vector3 AxisOfRotation = Vector3.Cross(Vector3.Up, v);
