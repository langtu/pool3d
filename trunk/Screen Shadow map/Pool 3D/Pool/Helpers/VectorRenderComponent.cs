...
namespace XNA_PoolGame.Helpers
{
    public class VectorRenderComponent : DrawableGameComponent
    {
        ...
        #region Constructor
        public VectorRenderComponent(Microsoft.Xna.Framework.Game _game, ContentManager content, string vectorRendererEffectName)
            : base(_game)
        {
        ...
        protected override void UnloadGraphicsContent(bool unloadAllContent)
        {
            ...
            if (unloadAllContent)
            {
                if (vertexDecl != null) vertexDecl.Dispose();
                vertexDecl = null;
            }
        }
        ...
        {
            const int numCircleSegments = 24;
        ...
        {
            /////////////////////////////////////////////////
            m_paramVP = null; m_paramWorld = null;
