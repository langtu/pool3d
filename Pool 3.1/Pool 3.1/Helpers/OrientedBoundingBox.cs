...
namespace XNA_PoolGame.Helpers
{
    public class OrientedBoundingBox
    {
        ...
        public OrientedBoundingBox(Vector3 center, Vector3 bounds)
            : this(center, bounds, Matrix.Identity)
        {
        }


        public OrientedBoundingBox(Vector3 center, Vector3 bounds, Matrix rotation)
        {
            this.center = center;
            this.bounds = bounds;
        ...
        public bool Intersects(OrientedBoundingBox b)
        {
