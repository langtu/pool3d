...
namespace XNA_PoolGame.Graphics.Particles
{
    ...
    public abstract class ParticleSystem : GameComponent, IDrawable, IKey<int>
    {
        ...
        void SetParticleRenderStates(RenderState renderState)
        {
            ...
            //renderState.StencilPass = StencilOperation.Zero;
        ...
        {
            int result = 1;
            if (obj != null && obj is ParticleSystem)
            {
                ParticleSystem bm = obj as ParticleSystem;
                result = this.drawOrder.CompareTo(bm.DrawOrder);
            }
            return result;
        }
